...
<html>
    ...
    <body>
        <div id="encabezado">
            ...
            NO FUNCIONA este action="." .- Figura en la solución de DWES03 correpondiente
            <form id="form_seleccion" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
            <form id="form_seleccion" method="post">              FUNCIONA
            <form id="form_seleccion" action="" method="post"> 
            <form id="form_seleccion" action="#" method="post">   FUNCIONA
            <form id="form_seleccion" action="obtencion_resultados_Resuelto.php" method="post"> 
            -->
...
// Rellenamos el desplegable con los datos de todos los productos
                    @ $dwes = new mysqli("randion.es", "dwes", "abc123.", "dwes");
