...
?>
<!DOCTYPE html>
<!-- OBSOLETO: PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">  -->
...
//   if (count($_SESSION['cesta'])==0) {
        ...
        if (@is_null($_SESSION['cesta']) or @count($_SESSION['cesta']) == 0) {
            ...
            <div id="productos">
                ...
                try {
                    ...
                    $dsn = "mysql:host=randion.es;dbname=dwes";
