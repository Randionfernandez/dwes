...
// Pendiente de comprobar este condicional                       
                            if (isset($rPerms[$v['Key']]) && (!$rPerms[$v['Key']]['inheritted'])) {
                                if ($userACL->hasPermission($v['Key'])) {
                                    echo " selected=\"selected\"";
                                }
                                echo ">Allow</option>";
                                echo "<option value=\"0\"";

                                if ($rPerms[$v['Key']]['value'] === false) {
                                    echo " selected=\"selected\"";
                                }
                                ...
                                echo "<option value=\"x\"";
                                if ((isset($rPerms[$v['Key']]) && $rPerms[$v['Key']]['inheritted'] == true) or!array_key_exists($v['Key'], $rPerms)) {
                                    echo " selected=\"selected\"";
                                    if (isset($rPerms[$v['Key']]) && $rPerms[$v['Key']]['value'] === true) {
                                        $iVal = '(Allow)';
                                    } else {
                                        $iVal = '(Deny)';
                                    }
